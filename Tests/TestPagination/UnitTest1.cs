namespace TestPagination
{
    ...
    public class UnitTest1
    {
        ...
        {
            Pagination.Pagination pagination = new(10, 0);
        ...
        {
            Pagination.Pagination pagination = new(10, 10);
            Assert.True(pagination.TotalPages == 1);
        }
        ...
        {
            Pagination.Pagination pagination = new(10, 20);
        ...
        {
            Pagination.Pagination pagination = new(10, 25);
        ...
        {
            Pagination.Pagination pagination = new(10, 26);
            Assert.True(pagination.TotalPages == 3);
        }
        ...
        {
            Pagination.Pagination pagination = new(10, 29);
            Assert.True(pagination.TotalPages == 3);
        }
        ...
        {
            Pagination.Pagination pagination = new(10, 21);
            Assert.True(pagination.TotalPages == 3);
        }
        ...
        {
            Pagination.Pagination pagination = new(10, 11);
            Assert.True(pagination.TotalPages == 2);
        }
        ...
        {
            Pagination.Pagination pagination = new(10, 30);
            Assert.True(pagination.TotalPages == 3);
        }
        ...
        {
            Pagination.Pagination pagination = new(10, 1);
            Assert.True(pagination.TotalPages == 1);
        }
        ...
        {
            Pagination.Pagination pagination = new(5, 6);
            Assert.True(pagination.TotalPages == 2);
        }
        ...
        {
            Pagination.Pagination pagination = new(0, 0);
            pagination.GetNextPage();
            pagination.GetNextPage();
        ...
        {
            Pagination.Pagination pagination = new(5, 11);
        ...
        {
            Pagination.Pagination pagination = new(2, 11);
        ...
        public void InValid_StartOn_P3_GoToPage_7_PageSize_11_Items_23()
        {
            //Total pages - 3
            //P1
            Pagination.Pagination pagination = new(11, 23);
            //P2
            pagination.GetNextPage();
            pagination.GetNextPage();
            pagination.GoToPage(7);
